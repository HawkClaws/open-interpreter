...
from .setup_revChatGPT_coding_llm import setup_revChatGPT_coding_llm
import os
...
def setup_llm(interpreter):
    ...
    if interpreter.model == "revChatGPT":
        coding_llm = setup_revChatGPT_coding_llm(interpreter)
    elif not interpreter.local and "gpt-" in interpreter.model:
